...
<?php
	...
	mysqli_query( $connect, "INSERT INTO electiveadmin VALUES ('', '$course_code', '$course_title', '$credits', '$elective_group', '$offered_sem', '$total_request', '$add_advising')" )

		or die("Can not execute query");



	echo "<p style='margin-left:30px;margin-top:10px;font-size:25px;text-align:center;font-weight:1000;'> Record inserted:<br> Course code = $course_code <br> Course Title = $course_title <br> Credits = $credits <br><br> Elective Group = $elective_group <br><br> Offered Sem = $offered_sem <br><br> Total request = $total_request <br><br> Add to advising = $add_advising</p>";
