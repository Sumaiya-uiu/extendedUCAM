...
<?php
	...
	while( $rows = mysqli_fetch_array( $results ) ) {
		...
		echo "<td><a href='register_course_result?course_id=".urldecode($course_id)."&request_type=".urldecode("drop")."&message=".urlencode("Student with $logged_in_student_id wants to drop course $course_code")."'>Drop</a></td>";
	}
